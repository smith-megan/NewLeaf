...
const Tutorialone = {
  1: [
    ...
    [
      ...
      "Take a look and make some best guesses, if it's a thick layer of polyurethan you should take a step back to scraping or using a chemical stripper to remove that layer.",
    ],
  ],
  2: [
    [image2, image3],
