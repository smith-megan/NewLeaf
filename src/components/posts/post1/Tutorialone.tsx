...
const Tutorialone = {
  ...
  2: {
    ...
    paragraphs: [
      ...
      "Many pieces of furniture are made by placing a thin decorative slice of wood over cheaper or easier to work with woods. A 'veneer' like this can easily be sanded all the way through especially if it is very thin.",
